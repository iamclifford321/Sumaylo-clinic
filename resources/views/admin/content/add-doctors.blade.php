...
<div class="container-fluid">
  ...
  <div class="row justify-content-md-center">
    <div class="col-sm-12 col-md-5">
      <form class="" action="{{route('admin.addDoctorAction')}}" method="post" style="/**max-height:800px; overflow-y:scroll; overflow-x:hidden">
        @csrf
        <div class="card">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-8">
                <div class="form-group">
                  ...
                  <input type="text" name="birthDate" value="{{old('birthDate')}}" class="form-control @error('birthDate') is-invalid @enderror">
            ...
            <div class="row">
              <div class="col-sm-12 col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="barangay" value="{{old('barangay')}}" class="form-control @error('barangay') is-invalid @enderror">
              ...
              <div class="col-sm-12 col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="municipality" value="{{old('municipality')}}" class="form-control @error('municipality') is-invalid @enderror">
              ...
              <div class="form-group">
                ...
                <div class="icheck-primary d-block">
                  <input type="checkbox" id="{{$service->id}}" name="services[]" value="{{$service->id}}" {{ (is_array(old('services')) && in_array($service->id, old('services'))) ? ' checked' : '' }}>
